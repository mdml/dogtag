...
| --- | --- |
| [README.md](../README.md) | what Dogtag is, and the first hour |
| [product.md](product.md) | the full product case — why now, who it is for, what is deliberately absent |
| [abstractions.md](abstractions.md) | the domain concepts the product is built from |
| [architecture.md](architecture.md) | the SDK's durable architectural obligations |
| [beta.md](beta.md) | the first release contract, including the milestone ladder |
| [strategy.md](strategy.md) | the experiment sequence beyond the build |
